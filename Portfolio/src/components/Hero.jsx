...
import { FaGithub, FaLinkedin, FaTwitter, FaFacebook, FaInstagram, FaDiscord } from 'react-icons/fa'
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        >
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 select-none">
            Hi, I'm <span className="text-secondary">Thanh Duong</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4">
            <Link to="contact" smooth={true} duration={500} offset={-80}>
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="text-dark btn btn-primary cursor-pointer"
              >
                Contact Me
              </motion.button>
            </Link>
          ...
          <div className="flex gap-4 mt-8">
            <motion.a
              href="https://github.com/DanielDoubleDx"
              target="_blank"
            ...
            <motion.a
              href="https://www.facebook.com/thanhduong3107"
              target="_blank"
              rel="noopener noreferrer"
              className="text-secondary hover:scale-110 transition-transform duration-300"
              whileHover={{ scale: 1.1 }}
            ...
            <motion.a
              href="https://www.instagram.com/cong_thanhh_/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-secondary hover:scale-110 transition-transform duration-300"
              whileHover={{ scale: 1.1 }}
            ...
            <motion.a
              href="https://discordapp.com/users/555312555300487169"
              target="_blank"
              rel="noopener noreferrer"
              className="text-secondary hover:scale-110 transition-transform duration-300"
              whileHover={{ scale: 1.1 }}
